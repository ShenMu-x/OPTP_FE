...
import { getAllCourse, courseType } from '@/utils/services';
import { CodeLangs } from '@/utils/option';
import { emptyCourse } from './default';

const refTableEl = ref();
const refEditEl = ref();
const course = ref<courseType>(emptyCourse);
...
<template>
    <div class="layout">
        ...
        <TablePage :page-size="6" :fetch-data="getAllCourse" ref="refTableEl" emptyDes="系统中暂无课程"
            ...
            <template v-slot:tableColumns>
                ...
                <el-table-column label="状态" min-width="80">
                    <template #default="scope">{{ scope.row.isClosed ? '已关闭' : '进行中' }}</template>
                </el-table-column>
